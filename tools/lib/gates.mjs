...
export const GATES = [
  ...
  },
  {
    ...
    reads: 'assembled',
    fileTargets: ['kitchen-sink.html', 'templates', 'js'],
    pageTargets: [],
    canRun: { sink: true, templates: true },
    inputs: ['css/rux.css', 'kitchen-sink.html', 'templates', 'js'],
  ...
  },
  {
    ...
    reads: 'assembled',
    fileTargets: ['css/rux.css', 'sink/harness.css', 'kitchen-sink.html', 'templates'],
    pageTargets: [],
    canRun: { sink: true, templates: true },
    inputs: ['css/rux.css', 'sink/harness.css', 'kitchen-sink.html', 'templates'],
  ...
  },
  {
    ...
    reads: 'assembled',
    fileTargets: ['kitchen-sink.html', 'templates'],
    pageTargets: [],
    canRun: { sink: true, templates: true },
    inputs: ['kitchen-sink.html', 'templates', 'docs/carbon-co-classes.json'],
  ...
  },
  {
    ...
    pageTargets: [],
    canRun: { sink: true, templates: true },
    inputs: ['kitchen-sink.html', 'templates', 'css/rux.css',
